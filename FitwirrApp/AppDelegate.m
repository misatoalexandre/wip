...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"willReseignActive" object:self];// pause timer and audio
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"didBecomeActive" object:self];//restart timer and audio
}
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"willTerminate" object:self]; //invalidate timer and nil the audio
}
